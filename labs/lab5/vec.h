...
template <class T> void Vec<T>::print() const {
	cout << "Number of elements stored in vector (m_size): " << m_size << endl;
	cout << "Number of array locations allocated,  m_size <= m_alloc (m_alloc):" << m_alloc << endl;
	cout << "Pointer to first location in the allocated array (m_data): " << m_data << endl;
	cout << "Contents of allocated array: " << endl;
	for (size_type i = 0; i < m_size; ++i) {
		cout << m_data[i] << " ";
	}
	cout << endl;
