...
void simple_test() {
  ...
  simple.plot(40,20);
  //simple.insert(simple_points[0].first,simple_points[0].second);
  //simple.insert(simple_points[1].first,simple_points[1].second);
  //cout << simple.size() << " " <<  simple.getRoot() << endl;
